        ...
        <el-row class='detail'>
            ...
            <el-col :span="17">
                <div class="detail-right">
                    ...
                    <el-button type='primary' size='medium' @click='goBack' style="margin: 40px 0 50px 0;">{{$t('btn.back')}}</el-button>
                </div>
            </el-col>
        </el-row>
...
<script>
    ...
    import { getInfo, getContact, getHit, getImg, getCustomerInfo, getAppInfo, getResultById, hisPage, getPercent, resolveGps } from 'api/trust/approvalDetail/index';
    ...
    export default {
        ...
        computed: {
            ...mapGetters(["elements", "language", "queryDetail"])
        },
        mounted () {
            this.viewer()
        },
        methods: {
            ...
            getParamsDetail () {
                this.orderId = this.queryDetail.orderId;
                this.imgQuery.userId = this.queryDetail.userId;
                this.imgQuery.channel = this.queryDetail.channel;
                this.prodId = this.queryDetail.prodId;
            },
            //查看认证结果
            seeResult () {
                let obj = {};
            ...
            getParams () {
                this.userId = this.queryDetail.userId;
                this.realName = this.queryDetail.realName;
            },
            getList() {
                //通话录
            ...
            goBack() {
                ...
                this.$router.push('/trust/achievements')
            }
        }
    }
</script>
