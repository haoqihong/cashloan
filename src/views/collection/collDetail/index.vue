...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getParamsDetail() {
                this.listQueryColl.orderId = this.collDetails.orderId
                this.overdueAmt = this.collDetails.overdueAmt
                this.customerInfo.realName = this.collDetails.realName
                this.customerInfo.appUserName = this.collDetails.appUserName
                this.customerInfo.companyTel = this.collDetails.companyTel
            },
            //表格
            getListColl() {
            ...
            submit() {
                if(this.inp1 !== '' && this.inp2 !== '' && this.inp3 !== '') {
                    ...
                    .then(() => {
                        let msg = {};
                        msg.taskId = this.collDetails.id;
                        msg.orderId = this.collDetails.orderId;
